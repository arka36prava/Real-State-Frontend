...
export const register = async (req,res) =>{
    ...
    try{
        ...
        const mailOptions = {
            ...
            text :` welcome to MERN-AUTH website. Your account is created 
            with email id :${email}`
...
export const sendVerifyOtp =async(req,res)=>{
    try{
       ...
       return res.json({success: true,message:
        "Verification OTP send to email successfully"
       });
...
// cheak user is authenticated or not
    ...
    try{
       ...
       const mailOption={
        from :process.env.SENDER_EMAIL,
            ...
            //text :`Your OTP for resetting password is ${otp} .Please use this OTP to reset your password`
